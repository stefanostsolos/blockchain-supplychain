...
class ImportShipmentItems extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedFile: null,
  ...
  onClickHandler = async () => {
    ...
    try {
        const toastId = toast.info("Uploading shipment items...", {
        ...
        if (response.data.message === "Success") {
            ...
            toast.success("Shipment items imported successfully!", {
                position: toast.POSITION.TOP_CENTER,
                onClose: () => {
...
export default ImportShipmentItems;