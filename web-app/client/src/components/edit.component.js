...
function EditProductWrapper() {
  ...
  return <EditProduct id={id} role={role} />;
}
...
class EditProduct extends Component {
  ...
  componentDidMount() {
    ...
    axios.get("http://localhost:8090/product/" + this.props.role + "/" + this.props.id, { headers: headers })
      .then((response) => {
        this.setState({
    ...
    axios.get("http://localhost:8090/history/" + this.props.role + "/" + this.props.id, { headers: headers })
      .then((response) => {
  ...
  onSubmit(e) {
    ...
    axios.put("http://localhost:8090/product/" + this.props.role + "/" + this.props.id, product, { headers: headers })
      .then((res) => {
