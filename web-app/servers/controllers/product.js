...
exports.updateProduct = async (req, res) => {
    ...
    let modelRes
    if (role === 'producer') {
        modelRes = await productModel.updateProduct(true, false, false, false, { productId, id, name, price });
    } else if (role === 'manufacturer') {
        modelRes = await productModel.updateProduct(false, true, false, false, { productId, id, name, price });
    } else if (role === 'distributor') {
        modelRes = await productModel.updateProduct(false, false, true, false, { productId, id, name, price });
    } else if (role === 'retailer') {
        modelRes = await productModel.updateProduct(false, false, false, true, { productId, id, name, price });
    } else {
        return apiResponse.badRequest(res);
    }
    return apiResponse.send(res, modelRes);
