...
exports.transactProduct = async (req, res) => {
    ...
    console.log('transact product 3');
...
exports.transactProductConsumer = async (req, res) => {
    ...
    console.log('transact product consumer 1');
    if (!name || !userId || !loggedUserType || !productId || !id) {
        return apiResponse.badRequest(res);
    }
    console.log('transact product consumer 2');
    let modelRes;
    ...
    console.log('transact product consumer 3');
    return apiResponse.send(res, modelRes);
};